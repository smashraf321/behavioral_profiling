...
DEPOT_LAT_N = [42.019205,41.997700,41.998902]
DEPOT_LAT_S = [42.018049,41.997229,41.998535]
DEPOT_LON_E = [-93.624976,-93.631859,-93.633839]
DEPOT_LON_W = [-93.626312,-93.633290,-93.634437]
...
RESEARCH_PARK = 1
RP_STOP_SIGN = 1
RP_NEW_LINK_GENETICS_STOP = 2
RP_NEW_LINK_GENETICS_DEPOT = 2

# set GEOFencing bounds
DEPOT_LAT_NORTH = DEPOT_LAT_N[ RP_NEW_LINK_GENETICS_DEPOT ]
DEPOT_LAT_SOUTH = DEPOT_LAT_S[ RP_NEW_LINK_GENETICS_DEPOT ]
DEPOT_LONG_EAST = DEPOT_LON_E[ RP_NEW_LINK_GENETICS_DEPOT ]
DEPOT_LONG_WEST = DEPOT_LON_W[ RP_NEW_LINK_GENETICS_DEPOT ]

START_LAT_NORTH = START_LAT_N[ RP_NEW_LINK_GENETICS_STOP ]
START_LAT_SOUTH = START_LAT_S[ RP_NEW_LINK_GENETICS_STOP ]
START_LONG_EAST = START_LON_E[ RP_NEW_LINK_GENETICS_STOP ]
START_LONG_WEST = START_LON_W[ RP_NEW_LINK_GENETICS_STOP ]
...
# not useful ATM
DIST_DEPOT_EXIT = 20
DIST_DEPOT_RETURN = 6000000

DIST_START_MIN1 = 170000
DIST_START_MAX1 = 190000
DIST_START_MIN2REGL = 102000
DIST_START_MAX2REGL = 103000
DIST_START_MIN2CIRC = 249000
DIST_START_MAX2CIRC = 250000
