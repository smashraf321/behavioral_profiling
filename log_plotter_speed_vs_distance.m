...
m = readmatrix('Documents/logs/log_LAPS_2019_06_01_13_10_03.csv',opts);
x1=m(:,2);
y1=m(:,1);
ax1 = subplot(5,1,1);
...
opts.SelectedVariableNames = [8 14];
m = readmatrix('Documents/logs/log_LAPS_2019_06_01_13_28_04.csv',opts);
x2=m(:,2);
y2=m(:,1);
ax2 = subplot(5,1,2);
...
hold(ax5,'off');
title(ax5,'Speed VS Distance - Lap 1 vs 2 vs 3 vs 4');
